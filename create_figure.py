...
# IoU values from your table
iou_data = [
    [0.73, 0.21, 0.22, 0.12, 0.11],  # bounding_box
    [0.61, 0.34, 0.33, 0.08, 0.07],  # box_plus_center
    [0.32, 0.14, 0.13, 0.02, 0.01],  # multiple_points_10
    [0.09, 0.06, 0.05, 0.01, 0.00],  # multiple_points_5
    [0.08, 0.05, 0.04, 0.00, 0.00],  # multiple_points_3
    [0.08, 0.05, 0.04, 0.00, 0.00],  # corners_plus_center
    [0.07, 0.05, 0.04, 0.00, 0.00]   # center_point
]
